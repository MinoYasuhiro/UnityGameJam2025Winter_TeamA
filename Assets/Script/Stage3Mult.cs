...
/// プレイヤー操作・制御クラス
/// </summary>
public class Stage3Mult : MonoBehaviour,IPushPlayerScript
{
    // オブジェクト・コンポーネント参照
    ...
    private void CheckRedCirclePenalty()
    {
    ...
    //void Teleport()
    //{
    //    transform.position = new Vector3(-8.53f, -3.769995f, 0.0f);
    //}
}